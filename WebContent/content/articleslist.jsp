												...
												<table class="table table-bordered">
													...
													%>
														<tr>
															...
															<td><%=a.getTitle()%></td>
															<td><%=a.getType()%></td>
															<td><a href="<%=a.getWebURL()%>">Click here</a></td>
															<td>
																<form method="post" action="${pageContext.request.contextPath}/content/article.jsp">
																	<input type="hidden" name="abstract" value="<%=a.getAbstractText() %>"><input
																	class="btn btn-primary"	type="submit" name="action" value="View">
																</form>
																</td>
															<td>
																<form method="post" action="${pageContext.request.contextPath}/Articles">
																	<input type="hidden" name="ID" value="<%=a.getId()%>">
																	<input type="hidden" name="title" value="<%=a.getTitle()%>"><input
																	class="btn btn-primary"	type="submit" name="action" value="View">
																</form>
																</td>
														</tr>			
